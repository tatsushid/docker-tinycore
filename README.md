...
- [`7.2-x86`, `latest` (7.2/x86/Dockerfile)](https://github.com/tatsushid/docker-tinycore/blob/master/7.2/x86/Dockerfile)
...
```bash
docker pull tatsushid/tinycore:7.2-x86
```
...
```bash
docker run -it tatsushid/tinycore:7.2-x86
```

or

```bash
docker run -it tatsushid/tinycore:7.2-x86_64
```
...
```bash
docker run -it --privileged tatsushid/tinycore:7.2-x86
```
